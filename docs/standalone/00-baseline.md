...
- [x] Revisar o checker e preservar regressões de vendor/generated/untracked/installer include/base Git.
...
- [x] Checker `changed/all` disponível para as fases seguintes e coberto por regressão dedicada.
